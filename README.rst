...
``www.example.com``, and ``example.net``, using the Apache plugin to both
obtain and install the certs, you could do this::

  ./letsencrypt-auto --apache -d example.com -d www.example.com -d example.net
...
can still use "standalone" or "webroot" plugins to obtain a certificate::
  ...
  ./letsencrypt-auto certonly --standalone --email admin@example.com -d example.com -d www.example.com -d example.net
