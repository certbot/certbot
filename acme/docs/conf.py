...
project = 'acme-python'
copyright = '2015, Let\'s Encrypt Project'
...
latex_documents = [
    (master_doc, 'acme-python.tex', 'acme-python Documentation',
     'Let\'s Encrypt Project', 'manual'),
]
...
man_pages = [
    (master_doc, 'acme-python', 'acme-python Documentation',
     [author], 1),
