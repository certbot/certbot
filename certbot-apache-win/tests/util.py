"""Common utilities for certbot_apache_win."""
import shutil
import sys
import unittest
...
from certbot_apache_win._internal import entrypoint
...
def get_apache_configurator(
    ...
    with mock.patch("certbot_apache_win._internal.configurator.util.run_script"):
        with mock.patch("certbot_apache_win._internal.configurator.util."
                        "exe_exists") as mock_exe_exists:
            mock_exe_exists.return_value = True
            with mock.patch("certbot_apache_win._internal.parser.ApacheParser."
                            "update_runtime_variables"):
                with mock.patch("certbot_apache_win._internal.apache_util.parse_from_subprocess") as mock_sp:
