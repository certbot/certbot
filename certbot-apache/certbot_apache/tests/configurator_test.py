...
class InstallSslOptionsConfTest(util.ApacheTest):
    ...
    def _current_ssl_options_hash(self):
        return crypto_util.sha256sum(self.config._pick_apache_config())  # pylint: disable=protected-access
    ...
    def test_manually_modified_current_file_does_not_update(self):
        ...
        self.assertEqual(crypto_util.sha256sum(
            self.config._pick_apache_config()),  # pylint: disable=protected-access
            self._current_ssl_options_hash())
