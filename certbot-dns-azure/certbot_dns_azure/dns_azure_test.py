...
class AuthenticatorTest(test_util.TempDirTestCase, dns_test_common.BaseAuthenticatorTest):
    ...
    def setUp(self):
        ...
        # _get_azure_client | pylint: disable=protected-access
    ...
    def test_without_auth(self, unused_mock):
        self.config.azure_credentials = None
...
class AzureClientTest(unittest.TestCase):
    ...
    def _setUp_client_with_mock(self, zone_request_side_effect):
        ...
        client = _AzureClient(ACCOUNT_JSON_PATH)
    ...
    @mock.patch('certbot_dns_azure.dns_google._GoogleClient.get_project_id')
    ...
    @mock.patch('oauth2client.service_account.ServiceAccountCredentials.from_json_keyfile_name')
    @mock.patch('certbot_dns_azure.dns_google.open',
