...
class _CloudflareClient:
    ...
    def __init__(self, email: Optional[str] = None, api_key: Optional[str] = None,
                 api_token: Optional[str] = None, check_cname: Optional[str] = False) -> None:
        self.check_cname = check_cname and check_cname.lower() == 'true'
        if email:
    ...
    def _find_target(self, domain: str, record_name: str) -> Optional[_CloudflareClientTarget]:
        """
        ...
        for zone_name in zone_name_guesses:
            ...
            if zones:
                ...
                return _CloudflareClientTarget(zone_id, target_record_name) if zone_id else None
