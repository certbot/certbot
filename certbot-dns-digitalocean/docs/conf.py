...
project = 'certbot-dns-digitalocean'
...
latex_documents = [
    (master_doc, 'certbot-dns-digitalocean.tex', 'certbot-dns-digitalocean Documentation',
...
man_pages = [
    (master_doc, 'certbot-dns-digitalocean', 'certbot-dns-digitalocean Documentation',
     [author], 1)
]
