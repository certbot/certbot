...
latex_documents = [
    (master_doc, 'certbot-dns-dnsimple.tex', 'certbot-dns-dnsimple Documentation',
...
man_pages = [
    (master_doc, 'certbot-dns-dnsimple', 'certbot-dns-dnsimple Documentation',
     [author], 1)
]
