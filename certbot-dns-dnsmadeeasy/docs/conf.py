...
project = 'certbot-dns-dnsmadeeasy'
...
latex_documents = [
    (master_doc, 'certbot-dns-dnsmadeeasy.tex', 'certbot-dns-dnsmadeeasy Documentation',
...
man_pages = [
    (master_doc, 'certbot-dns-dnsmadeeasy', 'certbot-dns-dnsmadeeasy Documentation',
     [author], 1)
]
