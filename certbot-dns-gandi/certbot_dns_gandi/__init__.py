...
========================================  =====================================
``--dns-gandi-credentials``               Gandi credentials_ INI file.
                                          (Required)
``--dns-gandi-propagation-seconds``       The number of seconds to wait for DNS
...
.. caution::
   ...
   Gandi account. Users who can read this file can use these credentials
