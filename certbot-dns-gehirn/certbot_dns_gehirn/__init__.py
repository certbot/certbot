...
removing, TXT records using the Gehirn DNS API.
...
========================================  =====================================
``--dns-gehirn-credentials``              Gehirn DNS credentials_ INI file.
                                          (Required)
...
Gehirn Infrastructure Service API credentials,
...
.. code-block:: ini
   ...
   dns_gehirn_api_token = xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
   dns_gehirn_api_secret = xxxxxxxxxxxxxxxxxxxxxxxxx-xxxx:000000000000000000
...
.. caution::
   ...
   Gehirn DNS account. Users who can read this file can use these credentials to issue
