...
latex_documents = [
    (master_doc, 'certbot-dns-gehirn.tex', 'certbot-dns-gehirn Documentation',
...
man_pages = [
    (master_doc, 'certbot-dns-gehirn', 'certbot-dns-gehirn Documentation',
     [author], 1)
]
