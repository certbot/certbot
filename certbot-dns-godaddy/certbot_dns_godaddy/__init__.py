...
credentials, obtained from your Godaddy account's `Applications & API
Tokens page <https://developer.godaddy.com/keys/>`_.
...
.. code-block:: ini
   ...
   dns_godaddy_key = 0000111122223333444455556666777788889999aaaabbbbccccddddeeeeffff
   dns_godaddy_secret = 0000111122223333444455556666777788889999aaaabbbbccccddddeeeeffff

The path to this file can be provided interactively or using the
``--dns-godaddy-credentials`` command-line argument. Certbot records the
