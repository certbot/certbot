...
latex_documents = [
    (master_doc, 'certbot-dns-linode.tex', 'certbot-dns-linode Documentation',
...
man_pages = [
    (master_doc, 'certbot-dns-linode', 'certbot-dns-linode Documentation',
     [author], 1)
]
