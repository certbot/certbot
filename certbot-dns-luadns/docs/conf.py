...
latex_documents = [
    (master_doc, 'certbot-dns-luadns.tex', 'certbot-dns-luadns Documentation',
...
man_pages = [
    (master_doc, 'certbot-dns-luadns', 'certbot-dns-luadns Documentation',
     [author], 1)
]
