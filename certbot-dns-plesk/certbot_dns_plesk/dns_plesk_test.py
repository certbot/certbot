...
class PleskClientTest(unittest.TestCase):
    ...
    def setUp(self):
        from certbot_dns_plesk.dns_plesk import _PleskClient

        self.plesk_client = _PleskClient(TOKEN)

        self.manager = mock.MagicMock()
        self.plesk_client.manager = self.manager
    ...
    def test_add_txt_record(self):
        ...
        self.plesk_client.add_txt_record(DOMAIN, self.record_name, self.record_content)
    ...
    def test_add_txt_record_fail_to_find_domain(self):
        ...
        self.assertRaises(errors.PluginError,
                          self.plesk_client.add_txt_record,
    ...
    def test_del_txt_record(self):
        ...
        self.plesk_client.del_txt_record(DOMAIN, self.record_name, self.record_content)
