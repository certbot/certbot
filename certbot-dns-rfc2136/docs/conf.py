...
latex_documents = [
    (master_doc, 'certbot-dns-rfc2136.tex', 'certbot-dns-rfc2136 Documentation',
...
man_pages = [
    (master_doc, 'certbot-dns-rfc2136', 'certbot-dns-rfc2136 Documentation',
     [author], 1)
]
