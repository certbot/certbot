...
project = 'certbot-dns-sakuracloud'
copyright = '2018, Certbot Project'
...
latex_documents = [
    (master_doc, 'certbot-dns-sakuracloud.tex', 'certbot-dns-sakuracloud Documentation',
...
man_pages = [
    (master_doc, 'certbot-dns-sakuracloud', 'certbot-dns-sakuracloud Documentation',
     [author], 1)
]
