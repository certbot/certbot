...
# On Windows os.stat call result is inconsistent, with a lot of flags that are not set or meaningless.
# We need to use specialized functions from the certbot.compat.filesystem module.
