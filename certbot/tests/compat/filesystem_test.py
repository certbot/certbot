...
class FilesystemTest(TempDirTestCase):
    ...
    def test_user_admin_dacl_consistency(self):
        ...
        security_owner = win32security.GetFileSecurity(
            target, win32security.OWNER_SECURITY_INFORMATION)
        ...
        security_dacl = win32security.GetFileSecurity(
            target, win32security.DACL_SECURITY_INFORMATION)
