...
class RenewalTest(test_util.ConfigTestCase):
    ...
    def test_ancient_webroot_renewal_conf(self, mock_set_by_cli):
        ...
        # pylint: disable=protected-access
        storage._restore_webroot_config(config, renewalparams)
    ...
    def test_webroot_params_conservation(self, mock_set_by_cli):
        ...
        storage._restore_webroot_config(self.config, renewalparams)  # pylint: disable=protected-access
...
class RestoreRequiredConfigElementsTest(test_util.ConfigTestCase):
    """Tests for certbot._internal.storage.restore_required_config_elements."""
    @classmethod
    def _call(cls, *args, **kwargs):
        from certbot._internal.storage import restore_required_config_elements
