...
class Reverter(object):
    ...
    def revert_temporary_config(self):
        ...
        :raises letsencrypt.client.errors.ReverterError:
    ...
    def rollback_checkpoints(self, rollback=1):
        ...
        :raises letsencrypt.client.errors.ReverterError: If there is a
            problem with the input or if the function is unable to
            ...
            if filename not in existing_filepaths:
                ...
                # http://stackoverflow.com/questions/4726260/effective-use-of-python-shutil-copy2
                    ...
                    logging.error(
                        ...
                        filename, cp_dir)
                    raise errors.ReverterError(
                        "Unable to add file {0} to checkpoint {1}".format(
                            filename, cp_dir))
                idx += 1
        op_fd.close()
    ...
    def register_file_creation(self, temporary, *files):
        ...
        :raises letsencrypt.client.errors.ReverterError:
            If call does not contain necessary parameters or if the file
    ...
    def _remove_contained_files(self, file_list):  # pylint: disable=no-self-use
        ...
        try:
            ...
            raise errors.ReverterError(
                "Unable to remove filepaths contained within {0}".format(
                    file_list))
